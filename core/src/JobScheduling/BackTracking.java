...
public abstract class BackTracking<T>
{
    ...
    protected void solve(int k)//Backtracking template
    {
    ...
    {
        int k=startingK;
        ArrayList<ArrayList<T>> nodeNexts=new ArrayList<ArrayList<T>>(); // structure to keep values/set for each node in tuple
